...
test('registry contains every persisted Quiet River transport backend',()=>{
  assert.deepEqual(listBackends(),['bili-cli-shervin','direct-feed','opencli-instagram-shervin','opencli-shervin','opencli-twitter-shervin','quiet-river-native','rsshub-ecs','twitter-cli-shervin','v2ex-public-api','werss-ecs','xiaohongshu-mcp-ecs','yt-dlp-ecs']);
