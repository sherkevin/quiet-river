...
function renderArticleCard(entry){
  ...
  a.innerHTML='<span class="unread-dot" role="img" aria-label="未读" title="未读"></span><div class="meta"><a data-author target="_blank" rel="noopener noreferrer"></a><span data-platform></span><span data-time></span><span class="badge" data-content></span></div><h2><a class="article-title" data-original target="_blank" rel="noopener noreferrer"></a></h2><div class="article-tags tag-chips"></div><p class="summary"></p><div class="reason"></div><div class="actions"><a class="primary" data-original target="_blank" rel="noopener noreferrer">打开原文</a><button data-action="read">阅读器</button><button data-action="tags">编辑标签</button><button data-action="mark"></button><button data-action="like"></button><button data-action="dislike"></button></div>';
  const authorLink=a.querySelector('[data-author]');authorLink.textContent=entry.source||entry.author||'未知博主';
  if(entry.sourceUrl)authorLink.href=entry.sourceUrl;else{authorLink.removeAttribute('href');authorLink.removeAttribute('target');authorLink.setAttribute('aria-disabled','true');authorLink.title='该博主暂无可用主页';}
