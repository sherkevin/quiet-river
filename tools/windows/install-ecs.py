...
def main():
    if os.geteuid() != 0 or len(sys.argv) != 2:
        raise SystemExit('Run as administrator with the Windows PUBLIC key file')
    ...
    print('Restricted collector account configured. No shell, port forwarding, or cloud keys granted.')
