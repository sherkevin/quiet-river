...
**这个实例也救不了我们那 17 个手记公众号**（深度学习炼丹、灵心通衢、智荐阁、
淘天集团智能算法产品、高德技术、机器学习与推荐算法、摘星星的孩子、algo邻家米铺、
丁丁丁写字的地方、诗品算法、搜广推学习笔记、阿尘学习笔记、秋枫学习笔记、RecRead、
州懂学习笔记、王喆的AI笔记、稳扎稳打学AI）——逐个查过，**两个目录都没有**。
它们仍是「只登记名字、去微信里搜」的手动源。
